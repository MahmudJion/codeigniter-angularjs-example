...
*/
$route['default_controller'] = 'welcome'; // Change 'welcome' to your default controller
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;

// Example custom route
$route['api/items'] = 'items_controller/index';
$route['api/items/(:num)'] = 'items_controller/show/$1';
